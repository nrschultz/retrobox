import Ava from 'ava';
import { TeamsFileParser, TeamsData } from '../../lib/teams_file_parser';

class TestableTeamsFileParser extends TeamsFileParser {
    public parse(fileName: string): TeamsData {
